...
const BigText = ({ text = ['big', 'text'], subtext = 'subtext' }) => {
  return (
    <div className={`
...
const RightBar = () => {
  return (
    <section className='absolute top-0 left-0 grid grid-cols-3 w-full h-full'>
      ...
      <BigText text={['featuring', 'art', 'by', 'john ivy']} subtext='abrupt pause' />
...
const EmptySection = ({ bg = 'bg-white', fg = 'text-slate-200', img, text }) => {
  return (
    <section
...
const Home = () => (
  <main>
    <div className='relative'>
      <RightBar />
      <EmptySection img='/images/main/hero.jpg' />
      <EmptySection bg='bg-slate-200' />
    </div>
